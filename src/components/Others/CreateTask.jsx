...
//                 <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text " placeholder='Make'></input>
//                 </div>
...
// export default CreateTask
    ...
    const submitHandler = (e) => {
      ...
      // Update userData with new employees array
